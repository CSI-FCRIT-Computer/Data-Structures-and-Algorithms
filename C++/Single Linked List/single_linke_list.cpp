...
int main()
{
	while(1)
	{
		...
		cout<<"5.delete at specified position"<<endl;
        cout<<"6.display linked list"<<endl;
        cout<<"7.find max"<<endl;
		cout<<"8.find min"<<endl;
        cout<<"9.display sum of elements of linked list"<<endl;
		cout<<"\n10.inserting a node at a desired position"<<endl;
        cout<<"11.reversing a linked list"<<endl;
